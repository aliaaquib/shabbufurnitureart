        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="space-y-5 flex justify-center flex-col xl:max-w-[500px]">
            ...
            >
              ...
              understanding their lifestyles to bring their unique vision to
              life. This collaborative spirit ensures that each space is a true
              reflection of our client’s personality, preferences, and way of
              living. We’re not just building interiors; we’re building
              long-lasting relationships grounded in trust and a shared vision.{" "}
            </motion.p>
            <motion.div
